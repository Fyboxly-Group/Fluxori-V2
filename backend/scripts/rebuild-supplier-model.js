/**
 * Script to rebuild the supplier.model.ts file
...
// File paths
const targetFile = path.join(__dirname, '../src/models/supplier.model.ts');
const backupFile = path.join(__dirname, '../src/models/supplier.model.ts.bak');
...
console.log('Successfully rebuilt supplier.model.ts');