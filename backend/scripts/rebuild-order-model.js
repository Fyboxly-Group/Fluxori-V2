/**
 * Script to rebuild the order.model.ts file
...
// File paths
const targetFile = path.join(__dirname, '../src/models/order.model.ts');
const backupFile = path.join(__dirname, '../src/models/order.model.ts.bak');
...
console.log('Successfully rebuilt order.model.ts');