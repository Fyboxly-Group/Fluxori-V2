/**
 * Script to rebuild the inventory-reorder-check.service.ts file
...
// File paths
const targetFile = path.join(__dirname, '../src/services/inventory-reorder-check.service.ts');
const backupFile = path.join(__dirname, '../src/services/inventory-reorder-check.service.ts.bak');
...
// Define the rebuilt service content
const newServiceContent = `import mongoose from 'mongoose';
...
// Write the new file
console.log('Writing new service file...');
fs.writeFileSync(targetFile, newServiceContent);

console.log('Successfully rebuilt inventory-reorder-check.service.ts');