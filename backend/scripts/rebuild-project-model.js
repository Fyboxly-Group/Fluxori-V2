/**
 * Script to rebuild the project.model.ts file
...
// File paths
const targetFile = path.join(__dirname, '../src/models/project.model.ts');
const backupFile = path.join(__dirname, '../src/models/project.model.ts.bak');
...
console.log('Successfully rebuilt project.model.ts');