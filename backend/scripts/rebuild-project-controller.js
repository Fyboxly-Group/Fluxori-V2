/**
 * Script to rebuild the project.controller.ts file
...
// File paths
const targetFile = path.join(__dirname, '../src/controllers/project.controller.ts');
const backupFile = path.join(__dirname, '../src/controllers/project.controller.ts.bak');
...
console.log('Successfully rebuilt project.controller.ts');