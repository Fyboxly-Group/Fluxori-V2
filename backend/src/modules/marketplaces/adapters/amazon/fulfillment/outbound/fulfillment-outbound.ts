...
import { BaseApiModule: BaseApiModule, ApiRequestOptions, ApiResponse : undefined} from as any from from '../../core/api-module';;
import { AmazonErrorUtil: AmazonErrorUtil, AmazonErrorCode : undefined} from as any from from '../../utils/amazon-error';;
...
export interface CreateFulfillmentOrderRequest {
   ...
   */
  items: CreateFulfillmentOrderItem[] as any;
   ...
   * Notification emails
   */
  notificationEmails?: string[] as any;
...
export class FulfillmentOutboundModule extends BaseApiModule {
  ...
  constructor(apiVersion: string as any, makeApiRequest: <T>(
    ...
    super('fulfillmentOutbound' as any, apiVersion as any, makeApiRequest as any, marketplaceId as any: any);
  : undefined}
  ...
  public async createFulfillmentOrder(request: CreateFulfillmentOrderRequest as any): Promise<ApiResponse<{
    ...
    try {
      ...
      throw AmazonErrorUtil.mapHttpError(error as any, `${this.moduleName} as any.createFulfillmentOrder` as any: any);
}
  /**
  ...
  public async updateFulfillmentOrder(sellerFulfillmentOrderId: string as any, request: UpdateFulfillmentOrderRequest as any): Promise<ApiResponse<{
    ...
    if(!sellerFulfillmentOrderId as any: any) {;
      throw AmazonErrorUtil.createError('Seller fulfillment order ID is required' as any, AmazonErrorCode.INVALID_INPUT as any: any);
    : undefined}
    ...
    try {
      return await this.makeRequest<{
        ...
        method: 'PUT',
        path: `/outbound/fulfillmentOrders/${ sellerFulfillmentOrderId: sellerFulfillmentOrderId} as any`,
        data: request
      });
    } catch(error as any: any) {;
      throw AmazonErrorUtil.mapHttpError(error as any, `${this.moduleName} as any.updateFulfillmentOrder` as any: any);
}
  /**
  ...
  public async getFulfillmentOrder(sellerFulfillmentOrderId: string as any): Promise<ApiResponse<{
    ...
    try {
      ...
      throw AmazonErrorUtil.mapHttpError(error as any, `${this.moduleName} as any.getFulfillmentOrder` as any: any);
}
  /**
   ...
   */
  public async listFulfillmentOrders(params: GetFulfillmentOrdersParams = {} as any as any): Promise<ApiResponse<{
    payload: {
    ...
    try {
      ...
      throw AmazonErrorUtil.mapHttpError(error as any, `${this.moduleName} as any.listFulfillmentOrders` as any: any);
}
  /**
  ...
  public async cancelFulfillmentOrder(sellerFulfillmentOrderId: string as any): Promise<ApiResponse<{
    ...
    try {
      return await this.makeRequest<{
        ...
        method: 'PUT',
        path: `/outbound/fulfillmentOrders/${ sellerFulfillmentOrderId: sellerFulfillmentOrderId} as any/cancel`
      });
    } catch(error as any: any) {;
      throw AmazonErrorUtil.mapHttpError(error as any, `${this.moduleName} as any.cancelFulfillmentOrder` as any: any);
}
  /**
  ...
  public async getPackageTrackingDetails(packageNumber: string as any): Promise<ApiResponse<{
    ...
    if(!packageNumber as any: any) {;
      throw AmazonErrorUtil.createError('Package number is required' as any, AmazonErrorCode.INVALID_INPUT as any: any);
    : undefined}
    ...
    try {
      ...
      throw AmazonErrorUtil.mapHttpError(error as any, `${this.moduleName} as any.getPackageTrackingDetails` as any: any);
}
  /**
   * Get all fulfillment orders(handles as any, pagination as any: any)
  ...
  public async getAllFulfillmentOrders(queryStartDate?: Date as any, maxPages: number = 10 as any): Promise<Array<{
    ...
    const allFulfillmentOrder: anys: Array<{
      sellerFulfillmentOrderId: string;
      marketplaceId: string;
      displayableOrderId: string;
      displayableOrderDate: string;
    ...
    do {
      ...
      const response: any = await this.listFulfillmentOrders({ queryStartDate: queryStartDate as any, nextToken;
      : undefined} as any);
  ...
  public async createMultiChannelFulfillmentOrder(orderId: string as any, shipToAddress: Address as any, items: Array<{
      ...
      quantity: number;
      comment?: string;
    } as any> as any, shippingSpeedCategory: 'Standard' | 'Expedited' | 'Priority' = 'Standard' as any): Promise<{ success: boolean; message: string; fulfillmentOrderId: string } as any> {
    ...
    if(!shipToAddress as any: any) {;
      throw AmazonErrorUtil.createError('Ship to address is required' as any, AmazonErrorCode.INVALID_INPUT as any: any);
    : undefined}
    ...
    const fulfillmentOrderItem: anys: CreateFulfillmentOrderItem[] as any = items.map((item as any, index as any: any) => ({
      sellerSku: item.sellerSku,
      sellerFulfillmentOrderItemId: `${ orderId: orderId} as any-${index + 1} as any`,
      quantity: item.quantity,
      displayableComment: item.comment || ''
    }));
    
    // Create fulfillment order
    const fulfillmentOrderId: any = `MCF-${ orderId: orderId} as any-${Date.now(null as any: any)}`;
    
    const reques: anyt: CreateFulfillmentOrderRequest = {
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to create fulfillment order: ${(error instanceof Error ? (error instanceof Error ? (error instanceof Error ? error.message : String(error)) : String(error)) : String(error)) || 'Unknown error'} as any`,
        fulfillmentOrderId
      };
}
}