...
export class MembershipController {
  ...
  async inviteClient(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (error.message.includes('not an agency')) {
        return res.status(400).json({
          success: false,
          message: error.message
        });
   ...
   */
  async changeMembershipType(req: Request, res: Response, next: NextFunction) {
    try {
      const { userId } = req.params;
      const { type } = req.body;
      const organizationId = req.user!.currentOrganizationId;
   ...
   */
  async addCustomPermission(req: Request, res: Response, next: NextFunction) {
    try {
      const { userId } = req.params;
   ...
   */
  async removeCustomPermission(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async addPermissionRestriction(req: Request, res: Response, next: NextFunction) {
    try {
      const { userId } = req.params;
      const { permission } = req.body;
      const organizationId = req.user!.currentOrganizationId;
   ...
   */
  async removePermissionRestriction(req: Request, res: Response, next: NextFunction) {
    try {
      const { userId, permission } = req.params;
      const organizationId = req.user!.currentOrganizationId;
   ...
   */
  async getUserMembership(req: Request, res: Response, next: NextFunction) {
    try {
      const { userId } = req.params;
      const organizationId = req.user!.currentOrganizationId;
